        ...
        <div class="container text-center">
            <div className="row justify-content-around">
                <div className="col-3 shadow p-3 mb-5 bg-body rounded">
                    ...
                    <h4>Zapatillas Af1 Looney Tunes</h4>
                    <div>
                ...
                <div className="col-3 shadow p-3 mb-5 bg-body rounded">
                    ...
                    <h4>Zapatillas Af1 high have a nike day</h4>
                    <div>
                        <p><a href="" target="_blank" className="btn btn-warning ">Mas Informacion</a></p>
                        <button className="btn btn-secondary">Comprar</button>
                    </div>
                ...
                <div className="col-3 shadow p-3 mb-5 bg-body rounded">
                    <p><img src="Jordan-4-Retro-Red-Thunder.jpg" alt="zapatillas Jordan modelo Retro Red Thunder color gris, negro y roja" className="img-fluid"/></p>
                    <h4>Zapatillas Jordan modelo Retro Red Thunder</h4>
                    <div>
                        <p><a href="" target="_blank" className="btn btn-warning ">Mas Informacion</a></p>
                        <button className="btn btn-secondary">Comprar</button>
                    </div>
